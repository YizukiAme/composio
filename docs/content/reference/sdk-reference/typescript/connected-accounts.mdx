...
```typescript
async update(nanoid: string, params: ConnectedAccountPatchParams): Promise<ConnectedAccountPatchResponse>
```
...
|------|------|-------------|
| `nanoid` | `string` | The unique identifier of the connected account |
| `params` | `ConnectedAccountPatchParams` | The update parameters |

**Returns**

`Promise<ConnectedAccountPatchResponse>` — The update response
